...
class FlightController extends Controller
{
    ...
    public function update(Flight $flight)
    {
        ...
        return tap($flight)->update([
            'airline_id' => $flightRequest['airline_id'],
            'origin_city_id' => $flightRequest['origin_city_id'],
            'destination_city_id' => $flightRequest['destination_city_id'],
